  ...
  `}function De(r){const e=r.position||"bottom-right",i=e.includes("left"),t=e.includes("top"),n=typeof r.offsetX=="number"?r.offsetX:24,s=typeof r.offsetY=="number"?r.offsetY:24,a=typeof r.buttonSize=="number"?r.buttonSize:56,d=typeof r.windowWidth=="number"?r.windowWidth:380,m=typeof r.windowHeight=="number"?r.windowHeight:580,y=12,o=s+a+y,c=i?"left":"right",g=t?"top":"bottom",p=t?"-14px":"14px",w=`${t?"top":"bottom"} ${i?"left":"right"}`,x=Math.max(a-4,44);return`
    ...
    @media (max-width: 480px) {
      .widget-window {
        ...
        height: calc(100dvh - ${x+s+y+16}px);
        max-height: calc(100dvh - ${x+s+y+16}px);
        ${g}: ${x+s+y}px;
        ${c}: 8px;
...
</svg>`;function et(r,e,i){const t=u("span",{class:"launcher__icon launcher__icon--chat",html:He}),n=u("span",{class:"launcher__icon launcher__icon--close",html:se}),s=u("span",{class:"launcher__badge","aria-label":"unread messages",role:"status"});s.setAttribute("hidden","");const a=u("button",{class:"launcher",type:"button","aria-label":`Open chat with ${i.botName}`,"aria-expanded":"false","aria-haspopup":"dialog"},t,n,s),d=()=>e.emit("toggle");a.addEventListener("click",d);function m(c,g){const p=c.isOpen!==(g==null?void 0:g.isOpen),w=c.unreadCount!==(g==null?void 0:g.unreadCount);if(p&&(a.classList.toggle("is-open",c.isOpen),a.setAttribute("aria-expanded",String(c.isOpen)),a.setAttribute("aria-label",c.isOpen?"Close chat":`Open chat with ${i.botName}`)),w||p){const x=c.unreadCount;x>0&&!c.isOpen?(s.textContent=x>99?"99+":String(x),s.removeAttribute("hidden"),s.setAttribute("aria-label",`${x} unread message${x!==1?"s":""}`)):s.setAttribute("hidden","")}}const y=r.subscribe(m);function o(){y(),a.removeEventListener("click",d)}return{el:a,destroy:o}}function tt(r,e,i){let t;if(i.avatarUrl){const _=u("img",{class:"header__avatar-img",src:i.avatarUrl,alt:`${i.botName} avatar`});_.addEventListener("error",()=>{_.replaceWith(n())}),t=_}else t=n();function n(){return u("span",{class:"header__avatar-fallback","aria-hidden":"true"},K(i.botName))}const s=u("span",{class:"header__status-dot",title:"Online","aria-hidden":"true"}),a=u("div",{class:"header__avatar"},t,s),d=u("div",{class:"header__name"},i.botName),m=u("div",{class:"header__subtitle"},"Active now"),y=u("div",{class:"header__info"},d,m),o=u("button",{class:"header__btn",type:"button","aria-label":"Turn on voice responses","aria-pressed":"false",title:"Voice responses",html:oe});o.setAttribute("hidden","");const c=()=>e.emit("tts-toggle");o.addEventListener("click",c);function g(_){const f=_.ttsSupported&&i.enableTTS!==!1;o.toggleAttribute("hidden",!f);const E=!!_.ttsEnabled;o.innerHTML=E?Ke:oe,o.setAttribute("aria-pressed",String(E)),o.setAttribute("aria-label",E?"Turn off voice responses":"Turn on voice responses"),o.title=E?"Voice responses: on":"Voice responses: off"}const p=u("button",{class:"header__btn header__btn--transfer",type:"button","aria-label":"Talk to a human agent",title:"Talk to a human",html:Ze}),w=()=>e.emit("request-transfer");p.addEventListener("click",w);function x(_){const f=_.transferState==="requested",E=_.transferState==="connected",l=_.transferState==="ended";p.classList.toggle("is-active",f||E),p.disabled=f||E||l,p.title=f?"Connecting to agent…":E?"Agent is connected":"Talk to a human"}const S=u("button",{class:"header__btn",type:"button","aria-label":"Close chat",html:Fe}),k=()=>e.emit("close");S.addEventListener("click",k);const C=u("div",{class:"header__actions"},o,p,S),v=u("header",{class:"header",role:"banner"},a,y,C);function z(_,f){(_.ttsEnabled!==(f==null?void 0:f.ttsEnabled)||_.ttsSupported!==(f==null?void 0:f.ttsSupported))&&g(_),_.transferState!==(f==null?void 0:f.transferState)&&x(_),_.agentName!==(f==null?void 0:f.agentName)&&_.agentName?m.textContent=`${_.agentName} (Human)`:_.agentName||(m.textContent=_.transferState==="requested"?"Connecting to agent…":"Active now")}const $=r.subscribe(z);g(r.getState()),x(r.getState());function W(){S.removeEventListener("click",k),o.removeEventListener("click",c),p.removeEventListener("click",w),$()}return{el:v,destroy:W}}function ce({suggestions:r=[],bus:e,messageId:i=null,ariaLabel:t="Suggested replies"}){const n=u("div",{class:"suggestions",role:"group","aria-label":t});let s=i,a=!1;function d(c){if(n.textContent="",!Array.isArray(c)||c.length===0){n.setAttribute("hidden","");return}n.removeAttribute("hidden"),c.forEach(g=>{const p=u("button",{type:"button",class:"suggestion-chip","aria-label":`Send: ${g}`});p.textContent=g,p.addEventListener("click",()=>{a||(y(!0),e.emit("suggestion-click",{text:g,messageId:s}))}),n.appendChild(p)})}function m({suggestions:c=[],messageId:g=s}={}){s=g,a=!1,d(c)}function y(c){a=!!c,n.classList.toggle("suggestions--disabled",a);for(const g of n.querySelectorAll(".suggestion-chip"))g.disabled=a,g.setAttribute("aria-disabled",String(a))}function o(){n.textContent=""}return d(r),{el:n,update:m,setDisabled:y,destroy:o}}function rt(r,e,i,t=!0){const n=r.role==="user";let s=null;if(!n)if(e.avatarUrl){const v=document.createElement("img");v.src=e.avatarUrl,v.alt="",s=u("div",{class:"bubble-avatar"},v),v.addEventListener("error",()=>{v.replaceWith(document.createTextNode(K(e.botName)))})}else s=u("div",{class:`bubble-avatar${t?"":" bubble-avatar--hidden"}`,"aria-hidden":"true"},K(e.botName));const a=u("div",{class:`bubble bubble--${n?"user":"assistant"}`});a.textContent=r.content;let d=null;if(n){d=u("div",{class:"bubble-retry-row","aria-live":"polite"}),d.setAttribute("hidden","");const v=u("button",{class:"bubble-retry-btn",type:"button","aria-label":"Retry sending this message",html:`${qe} Retry`});v.addEventListener("click",()=>{i.emit("retry-message",{messageId:r.id,content:r.content})});const z=u("span",{class:"bubble-retry-row__text"},"Failed to send.");d.appendChild(z),d.appendChild(v)}const m=u("span",{class:"bubble-meta__time"},ae(r.timestamp));let y=null;n&&(y=u("span",{class:"bubble-meta__status","aria-hidden":"true",html:le}),y.setAttribute("hidden",""));const o=u("div",{class:`bubble-meta bubble-meta--${n?"user":"assistant"}`,"aria-label":new Date(r.timestamp).toLocaleTimeString()},m,y);let c=null;n||(c=ce({suggestions:Array.isArray(r.suggestions)?r.suggestions:[],bus:i,messageId:r.id}));const g=[a];c&&g.push(c.el),d&&g.push(d),g.push(o);const p=u("div",{class:"bubble-content"},...g),w=n?[p]:[s,p],x=u("div",{class:`bubble-wrapper bubble-wrapper--${n?"user":"assistant"}`,role:"listitem","data-message-id":r.id},...w);S(r.status);function S(v){a.classList.remove("bubble--sending","bubble--failed"),v==="sending"?(a.classList.add("bubble--sending"),d&&d.setAttribute("hidden",""),y&&y.setAttribute("hidden","")):v==="failed"?(a.classList.add("bubble--failed"),d&&d.removeAttribute("hidden"),y&&y.setAttribute("hidden","")):(d&&d.setAttribute("hidden",""),y&&(y.innerHTML=v==="delivered"?Je:le,y.classList.toggle("bubble-meta__status--delivered",v==="delivered"),y.classList.toggle("bubble-meta__status--sent",v!=="delivered"),y.removeAttribute("hidden")))}function k(v){if(v.content!==r.content&&(a.textContent=v.content,r.content=v.content),v.status!==r.status&&(r.status=v.status,S(v.status)),v.timestamp!==r.timestamp&&(r.timestamp=v.timestamp,m.textContent=ae(v.timestamp),o.setAttribute("aria-label",new Date(v.timestamp).toLocaleTimeString())),c){const z=Array.isArray(v.suggestions)?v.suggestions:[],$=Array.isArray(r.suggestions)?r.suggestions:[];(z.length!==$.length||z.some((W,_)=>W!==$[_]))&&(r.suggestions=z,c.update({suggestions:z,messageId:r.id}))}}function C(v){s&&s.classList.toggle("bubble-avatar--hidden",!v)}return{el:x,update:k,setAvatarVisible:C}}const nt=[{delayMs:1500,text:"Thinking…"},{delayMs:5e3,text:"Processing…"},{delayMs:1e4,text:"Almost ready…"}];function it(r,e){let i;if(e.avatarUrl){i=u("div",{class:"bubble-avatar"});const p=document.createElement("img");p.src=e.avatarUrl,p.alt="",p.addEventListener("error",()=>{p.replaceWith(document.createTextNode(K(e.botName)))}),i.appendChild(p)}else i=u("div",{class:"bubble-avatar","aria-hidden":"true"},K(e.botName));const t=u("div",{class:"typing-dots","aria-hidden":"true"},u("span",{class:"typing-dot"}),u("span",{class:"typing-dot"}),u("span",{class:"typing-dot"})),n=u("span",{class:"typing-label","aria-live":"polite"}),s=u("div",{class:"typing-bubble"},t,n),a=u("div",{class:"typing-indicator",role:"status","aria-label":`${e.botName} is thinking`},i,s);a.setAttribute("hidden","");let d=[];function m(){n.textContent="",n.classList.remove("typing-label--visible"),d=nt.map(({delayMs:p,text:w})=>setTimeout(()=>{n.textContent=w,n.classList.add("typing-label--visible"),a.setAttribute("aria-label",`${e.botName}: ${w}`)},p))}function y(){d.forEach(clearTimeout),d=[],n.textContent="",n.classList.remove("typing-label--visible"),a.setAttribute("aria-label",`${e.botName} is thinking`)}function o(p,w){p.status!==(w==null?void 0:w.status)&&(p.status==="loading"?(a.removeAttribute("hidden"),m()):(a.setAttribute("hidden",""),y()))}const c=r.subscribe(o);function g(){y(),c()}return{el:a,destroy:g}}function at(r,e,i){const t=u("div",{class:"sr-only","aria-live":"polite","aria-atomic":"false",role:"log"});let n;if(i.avatarUrl){const l=document.createElement("img");l.src=i.avatarUrl,l.alt="",l.style.cssText="width:100%;height:100%;object-fit:cover;border-radius:50%",n=u("div",{class:"messages-welcome__avatar"},l)}else n=u("div",{class:"messages-welcome__avatar"},K(i.botName));const s=ce({suggestions:Array.isArray(i.defaultSuggestions)?i.defaultSuggestions:[],bus:e,messageId:null,ariaLabel:"Quick start options"}),a=u("div",{class:"messages-welcome__title"},`Hi, I'm ${i.botName}`),d=u("div",{class:"messages-welcome__hint"},u("span",{class:"messages-welcome__hint-icon",html:Xe}),"AI Assistant"),m=u("div",{class:"messages-welcome","aria-hidden":"true"},n,d,a,u("p",{class:"messages-welcome__text"},i.welcomeMessage),s.el),{el:y,destroy:o}=it(r,i),c=u("div",{role:"list","aria-label":"Chat messages"}),g=u("span",{class:"scroll-to-bottom__count"});g.setAttribute("hidden","");const p=u("button",{type:"button",class:"scroll-to-bottom","aria-label":"Jump to latest message"},u("span",{class:"scroll-to-bottom__icon",html:Ge,"aria-hidden":"true"}),u("span",{class:"scroll-to-bottom__label"},"Latest"),g),w=u("div",{class:"messages-area","aria-label":"Messages",tabindex:"0"},m,c,y,p,t),x=new Map;let S=!1,k=0,C=0;function v(){const l=S;p.classList.toggle("is-visible",l),l||(C=0),z()}function z(){C>0?(g.textContent=C>99?"99+":String(C),g.removeAttribute("hidden")):g.setAttribute("hidden","")}w.addEventListener("scroll",()=>{const l=w.scrollHeight-w.scrollTop-w.clientHeight,b=S;S=l>60,b!==S&&v()},{passive:!0}),p.addEventListener("click",()=>{S=!1,C=0,$(!0),v()});function $(l=!1){(!S||l)&&requestAnimationFrame(()=>{w.scrollTop=w.scrollHeight})}function W(l){const b=new Set(l.map(A=>A.id));for(const[A,B]of x)b.has(A)||(B.el.remove(),x.delete(A));l.forEach((A,B)=>{var P;const N=B===l.length-1||((P=l[B+1])==null?void 0:P.role)!==A.role;if(x.has(A.id)){const{handle:F}=x.get(A.id);F.update(A),F.setAvatarVisible(A.role==="assistant"&&N)}else{const F=A.role==="assistant"&&N,V=rt(A,i,e,F);c.appendChild(V.el),x.set(A.id,{el:V.el,handle:V}),A.role==="assistant"&&Be(t,`${i.botName}: ${A.content}`)}})}function _(l,b){const A=l.messages!==(b==null?void 0:b.messages),B=l.status!==(b==null?void 0:b.status);if(A){const N=l.messages.length>0;if(m.setAttribute("aria-hidden",String(N)),m.style.display=N?"none":"",W(l.messages),l.messages.length>k)if(S){const V=l.messages.slice(k).filter(Q=>Q.role==="assistant").length;C+=V,z()}else $(!0);k=l.messages.length}B&&l.status==="loading"&&$(),w.setAttribute("aria-busy",String(l.status==="loading"))}const f=r.subscribe(_);_(r.getState(),null);function E(){f(),o(),s.destroy(),x.clear()}return{el:w,scrollToBottom:$,destroy:E}}const J=2e3,de=1700;function st(r,e,i){const t=document.createElement("textarea");t.className="input-textarea",t.placeholder=`Message ${i.botName}…`,t.setAttribute("aria-label","Type a message"),t.setAttribute("rows","1"),t.setAttribute("maxlength",String(J)),t.setAttribute("autocomplete","off"),t.setAttribute("spellcheck","true");const n=u("button",{class:"send-btn",type:"button","aria-label":"Send message",html:Pe,disabled:""}),s=u("button",{class:"voice-btn",type:"button","aria-label":"Start voice input","aria-pressed":"false",html:Ye});s.setAttribute("hidden",""),s.addEventListener("click",()=>{k()||e.emit("voice-toggle")});const a=u("div",{class:"input-wrapper"},t),d=u("span",{class:"interim-transcript__dot","aria-hidden":"true"}),m=u("span",{class:"interim-transcript__text"}),y=u("div",{class:"interim-transcript",role:"status","aria-live":"polite"},d,m);y.setAttribute("hidden","");const o=u("div",{class:"input-counter","aria-live":"polite"}),c=u("div",{class:"input-area",role:"form","aria-label":"Message input"},a,s,n),g=u("div",{class:"input-container"},y,c,o);i.hideAttribution||g.appendChild(u("div",{class:"input-footer"},u("span",{class:"input-footer__text"},"Powered by AI Receptionist")));function p(){t.style.height="auto",t.style.height=`${t.scrollHeight}px`}t.addEventListener("input",()=>{p(),w(),x()});function w(){const l=t.value.trim().length>0;n.disabled=!l||k()}function x(){const l=t.value.length,b=J-l;o.classList.toggle("is-visible",l>=de),o.classList.toggle("is-warn",l>=de&&l<J),o.classList.toggle("is-limit",l>=J),o.textContent=`${b} left`}function S(){const l=t.value.trim();!l||k()||(e.emit("send",l),t.value="",t.style.height="auto",n.disabled=!0,x(),t.focus())}n.addEventListener("click",S),t.addEventListener("keydown",l=>{if((l.ctrlKey||l.metaKey)&&l.key.toLowerCase()==="m"){!s.hasAttribute("hidden")&&!k()&&(l.preventDefault(),e.emit("voice-toggle"));return}l.key==="Enter"&&!l.shiftKey&&(l.preventDefault(),S())});function k(){const l=r.getState();return l.status==="loading"||l.online===!1}function C(l){t.disabled=l,a.classList.toggle("is-disabled",l),l?n.disabled=!0:w()}function v(l){l.online===!1?t.placeholder="You are offline — messages will resume once reconnected":l.voiceState==="listening"?t.placeholder="Listening… speak now or click mic to stop":l.status==="loading"?t.placeholder=`${i.botName} is thinking…`:t.placeholder=`Message ${i.botName}…`}function z(l){const b=l.sttSupported&&i.enableVoice!==!1;s.toggleAttribute("hidden",!b);const A=l.voiceState==="listening";s.classList.toggle("is-listening",A),s.setAttribute("aria-pressed",String(A)),s.setAttribute("aria-label",A?"Stop voice input":"Start voice input")}function $(l){const b=l.voiceState==="listening"&&typeof l.interimTranscript=="string"&&l.interimTranscript.trim().length>0;y.toggleAttribute("hidden",!b),b&&(m.textContent=l.interimTranscript)}function W(l,b){(l.status!==(b==null?void 0:b.status)||l.online!==(b==null?void 0:b.online))&&C(k()),(l.status!==(b==null?void 0:b.status)||l.online!==(b==null?void 0:b.online)||l.voiceState!==(b==null?void 0:b.voiceState))&&v(l),(l.voiceState!==(b==null?void 0:b.voiceState)||l.sttSupported!==(b==null?void 0:b.sttSupported))&&z(l),(l.interimTranscript!==(b==null?void 0:b.interimTranscript)||l.voiceState!==(b==null?void 0:b.voiceState))&&$(l)}const _=r.subscribe(W);W(r.getState(),null),x();function f(){requestAnimationFrame(()=>t.focus())}function E(){_()}return{el:g,focus:f,destroy:E}}function ot(r,e){const i=u("span",{class:"error-banner__icon",html:Ve,"aria-hidden":"true"}),t=u("span",{class:"error-banner__text"}),n=u("button",{class:"error-banner__retry",type:"button","aria-label":"Retry"},"Retry"),s=u("button",{class:"error-banner__dismiss",type:"button","aria-label":"Dismiss error",html:se}),a=u("div",{class:"error-banner",role:"alert","aria-live":"assertive"},i,t,n,s);a.setAttribute("hidden",""),n.addEventListener("click",()=>{e.emit("retry-last")}),s.addEventListener("click",()=>{e.emit("dismiss-error")});function d(o,c){o.error!==(c==null?void 0:c.error)&&(o.error?(t.textContent=o.error.message,n.style.display=o.error.retryable?"":"none",a.removeAttribute("hidden")):a.setAttribute("hidden",""))}const m=r.subscribe(d);function y(){m()}return{el:a,destroy:y}}function lt(r){const e=u("div",{class:"offline-banner",role:"status","aria-live":"polite"},u("span",{html:Qe,"aria-hidden":"true"}),u("span",null,"You are offline — we will reconnect automatically"));e.setAttribute("hidden","");function i(n,s){n.online!==(s==null?void 0:s.online)&&e.toggleAttribute("hidden",n.online!==!1)}const t=r.subscribe(i);return{el:e,destroy(){t()}}}function ct(r,e){var ge,fe;const i=document.createElement("style");i.textContent=[Ue(e),De(e),We(),je()].join(`
`),r.appendChild(i);const t=we(e.apiKey,e.sessionTtlHours),n=t.load(),s=(ge=n==null?void 0:n.sessionId)!=null?ge:t.createNew(),a=(fe=n==null?void 0:n.messages)!=null?fe:[];e.sessionId=s;const d=Te(),m=Ce({lang:e.voiceLang||"en-US",onResult:({text:h,isFinal:L})=>{L?(o.setState({interimTranscript:""}),h&&p.emit("send",h)):o.setState({interimTranscript:h})},onError:h=>{o.setState({voiceState:"idle",interimTranscript:"",error:{message:h.message,retryable:!1,failedMessageId:null}})},onStateChange:h=>{h!=="listening"?o.setState({voiceState:h,interimTranscript:""}):o.setState({voiceState:h})}}),y=Ee({enabled:!!e.enableSounds,volume:typeof e.soundVolume=="number"?e.soundVolume:.18}),o=he(ye(s,a,{sttSupported:m.sttSupported,ttsSupported:m.ttsSupported,ttsEnabled:m.ttsSupported&&e.enableTTS!==!1&&!!e.ttsDefaultOn,online:d.isOnline()}));m.setMuted(!o.getState().ttsEnabled);let c=null;o.subscribe(h=>{clearTimeout(c),c=setTimeout(()=>{t.save(h.sessionId,h.messages)},300)});const g=d.subscribe(h=>{o.setState({online:h})}),p=Me(),{el:w}=et(o,p,e),{el:x,destroy:S}=tt(o,p,e),{el:k,destroy:C}=lt(o),{el:v,scrollToBottom:z}=at(o,p,e),{el:$}=ot(o,p),{el:W,focus:_}=st(o,p,e),f=document.createElement("div");f.className="widget-window",f.setAttribute("role","dialog"),f.setAttribute("aria-modal","true"),f.setAttribute("aria-label",`Chat with ${e.botName}`),f.setAttribute("aria-hidden","true"),f.appendChild(x),f.appendChild(k),f.appendChild(v),f.appendChild($),f.appendChild(W),r.appendChild(f),r.appendChild(w);const E=Re(f);let l=w;p.on("toggle",()=>{const{isOpen:h}=o.getState();h?A():b()}),p.on("close",()=>{A()}),p.on("send",h=>{F(h)}),p.on("retry-last",()=>{const{messages:h}=o.getState(),L=[...h].reverse().find(T=>T.role==="user"&&T.status==="failed");L&&V(L)}),p.on("retry-message",({messageId:h,content:L})=>{const{messages:T}=o.getState(),I=T.find(O=>O.id===h);I&&V(I)}),p.on("dismiss-error",()=>{o.setState({error:null})}),p.on("suggestion-click",({text:h,messageId:L})=>{L&&o.setState(T=>({messages:T.messages.map(I=>I.id===L?q(M({},I),{suggestions:[]}):I)})),F(h)}),p.on("voice-toggle",()=>{const h=o.getState();h.status!=="loading"&&(h.voiceState==="listening"?m.stopListening():(m.cancelSpeaking(),m.startListening()))}),p.on("tts-toggle",()=>{const h=!o.getState().ttsEnabled;o.setState({ttsEnabled:h}),m.setMuted(!h),h||m.cancelSpeaking()}),p.on("request-transfer",()=>{P()});function b(){o.setState({isOpen:!0,unreadCount:0}),f.classList.add("is-open"),f.removeAttribute("aria-hidden"),E.activate(null),_(),z(!0),f.setAttribute("aria-label",`Chat with ${e.botName} — dialog`)}function A(){o.setState({isOpen:!1}),f.classList.remove("is-open"),f.setAttribute("aria-hidden","true"),E.deactivate(l),m.stopListening(),m.cancelSpeaking()}const B=h=>{h.key==="Escape"&&o.getState().isOpen&&A()};document.addEventListener("keydown",B);let N=null;async function P(){if(o.getState().transferState!=="none"||!e.apiKey||!e.apiUrl)return;o.setState({transferState:"requested",status:"loading"});const L={id:Y(),role:"assistant",content:"🔄 Connecting you to a human agent. Please hold on…",timestamp:Date.now(),status:"sent",isSystem:!0};o.setState(I=>({messages:[...I.messages,L],status:"idle"}));try{await ze(e)}catch(I){o.setState({transferState:"none",error:{message:"Could not connect to a human agent right now. Please try again.",retryable:!0,failedMessageId:null},status:"error"});return}let T;try{const I=new URL(e.apiUrl);T=`${I.protocol}//${I.host}`}catch(I){T=e.apiUrl.replace(/\/api\/.*$/,"")}try{let I=typeof window!="undefined"&&window.io;I||(await new Promise((O,U)=>{const j=document.createElement("script");j.src=`${T}/socket.io/socket.io.js`,j.onload=O,j.onerror=U,document.head.appendChild(j)}),I=window.io),I&&(N=I(T,{transports:["websocket","polling"]}),N.on("connect",()=>{N.emit("join-session",{sessionId:e.sessionId,tenantId:e.apiKey})}),N.on("agent-joined",({agentName:O})=>{o.setState({transferState:"connected",agentName:O});const U={id:Y(),role:"assistant",content:`✅ ${O} has joined the conversation.`,timestamp:Date.now(),status:"sent",isSystem:!0};o.setState(j=>({messages:[...j.messages,U]})),z(!0)}),N.on("new-message",({content:O,isHuman:U,agentName:j})=>{if(!U)return;const Z={id:Y(),role:"assistant",content:O,timestamp:Date.now(),status:"sent"};o.setState(ee=>({messages:[...ee.messages,Z]})),y.play("receive"),o.getState().isOpen||o.setState(ee=>({unreadCount:ee.unreadCount+1})),z(!0)}),N.on("session-ended",()=>{o.setState({transferState:"ended",agentName:null});const O={id:Y(),role:"assistant",content:"The conversation has been closed by the agent.",timestamp:Date.now(),status:"sent",isSystem:!0};o.setState(U=>({messages:[...U.messages,O]})),N&&N.disconnect(),N=null}))}catch(I){console.warn("[AI Widget] Socket.IO unavailable; transfer request sent via REST.",I)}}async function F(h){const L=o.getState();if(L.status==="loading")return;const T={id:Y(),role:"user",content:h,timestamp:Date.now(),status:"sending"};if(o.setState(I=>({messages:[...I.messages,T],status:"idle",error:null})),y.play("send"),L.transferState==="connected"&&(N!=null&&N.connected)){N.emit("patient-message",{sessionId:e.sessionId,content:h}),o.setState(I=>({messages:I.messages.map(O=>O.id===T.id?q(M({},O),{status:"sent"}):O)}));return}o.setState({status:"loading"}),await Q(T)}async function V(h){o.setState(L=>({messages:L.messages.map(T=>T.id===h.id?q(M({},T),{status:"sending"}):T),status:"loading",error:null})),await Q(h)}async function Q(h){o.setState(L=>({messages:L.messages.map(T=>T.id===h.id?q(M({},T),{status:"sent"}):T)}));try{const L=o.getState().messages.filter(U=>U.status!=="failed"),{reply:T,suggestions:I}=await Ne(L,e),O={id:Y(),role:"assistant",content:T,timestamp:Date.now(),status:"sent",suggestions:I};o.setState(U=>({messages:[...U.messages.map(j=>{var Z;return j.role==="assistant"&&((Z=j.suggestions)!=null&&Z.length)?q(M({},j),{suggestions:[]}):j}),O],status:"idle",error:null})),o.getState().isOpen||o.setState(U=>({unreadCount:U.unreadCount+1})),y.play("receive"),o.getState().ttsEnabled&&m.speak(T)}catch(L){const T=Le(L);o.setState(I=>({messages:I.messages.map(O=>O.id===h.id?q(M({},O),{status:"failed"}):O),status:"error",error:{message:T.message,retryable:T.retryable,failedMessageId:h.id}})),y.play("error"),console.error("[AI Widget] API call failed:",L)}}function pt(){document.removeEventListener("keydown",B),p.clear(),c&&clearTimeout(c);try{g()}catch(h){}try{d.destroy()}catch(h){}try{m.destroy()}catch(h){}try{y.destroy()}catch(h){}try{S()}catch(h){}try{C()}catch(h){}try{N&&N.disconnect()}catch(h){}}return{open:b,close:A,toggle:()=>o.getState().isOpen?A():b(),destroy:pt,on:(h,L)=>p.on(h,L),off:(h,L)=>p.off(h,L),getState:()=>M({},o.getState())}}const ue="ai-receptionist-widget-host";function dt(r){if(document.getElementById(ue))return console.warn("[AI Widget] Already initialized. Call window.LinorWidget.destroy() first to re-mount."),typeof window!="undefined"&&window.LinorWidget||null;const e=document.createElement("div");e.id=ue,e.style.cssText=["position: fixed","z-index: 2147483647","top: 0","left: 0","width: 0","height: 0","overflow: visible","pointer-events: none"].join("; ");const i=e.attachShadow({mode:"closed"});document.body.appendChild(e);const t=ct(i,r),n=t.destroy;return t.destroy=()=>{n(),e.remove(),typeof window!="undefined"&&window.LinorWidget===t&&delete window.LinorWidget},t}const ut=typeof document!="undefined"?document.currentScript:null;function pe(){const r=D(ut);if(!r.apiKey||!r.apiUrl)return;const e=dt(r);e&&typeof window!="undefined"&&(window.LinorWidget=e)}typeof document!="undefined"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",pe,{once:!0}):pe())})();
